...
if (!class_exists('Wdfsnfw_Admin_Core_Elements')) :
	 ...
	 * @since   1.0.0
	 */
	class Wdfsnfw_Admin_Core_Elements {
		...
		public function __construct( $setting) {
			...
			$this->wdfsnfwAdminCheckFieldType();
		}
		 ...
		 */
		public function wdfsnfwAdminCheckFieldType() {
										...
										<div class="row" id="row_<?php echo esc_html($value['field']); ?>">
											...
											<div class="col-12 col-md-6">
												...
												if ('select' == $value['type']) {
													...
													<img class="wdfsnfw-search-loader d-none" src="<?php echo esc_url(plugin_dir_url(__DIR__) . 'img/Loading_icon.gif'); ?>" alt=''>
													<?php
													...
													wp_enqueue_media();
													?>
													<input type="hidden" name="wdfsnfw_remove_image_default_value" class="wdfsnfw_remove_image_default_value" value="<?php echo esc_attr(plugin_dir_url(__DIR__) . 'img/default-upload-image.jpg'); ?>">
													...
													<a class="wdfsnfw_remove_image" href="#"><small>Remove</small></a>
													<br>
													<input class="form-control btn-lg wdfsnfw_admin_accordion_img_btn <?php echo esc_html($value['class']); ?>" id="<?php echo esc_attr($value['field']); ?>" name="<?php echo esc_attr($value['field']); ?>" style="width: 100px;" type="button" value="Upload">
													<?php
												} else if ('audio' == $value['type']) {
													wp_enqueue_media();
													?>
													<div class="wdfsnfw_audio_div">
														<audio class="pb-3 wdfsnfw_add_audio_file" controls>
															<source id="wdfsnfw_add_audio_file_show" src="<?php echo esc_url($value['value']); ?>" type="audio/mpeg">
														</audio>
														<input class="form-control btn-lg wdfsnfw_admin_accordion_img_btn <?php echo esc_html($value['class']); ?>" id="<?php echo esc_attr($value['field']); ?>" name="<?php echo esc_attr($value['field']); ?>" style="width: 50%;" type="button" value="Upload">
													</div>
													<?php
												}
												?>
		...
		*/
		...
		public function searchBox() {
            ...
            <img width="30" class="wdfsnfw-search-switch" src="' . plugin_dir_url(__DIR__) . 'img/switch.webp" alt=""><img class="wdfsnfw-search-loader d-none" src="' . plugin_dir_url(__DIR__) . 'img/Loading_icon.gif" alt=""><select class="form-control  non-accordion-multiselect wdfsnfw_admin_product_settings" name="' . esc_attr($this->setting['field']) . '_multiselect" id="' . esc_attr($this->setting['field']) . '_multiselect" multiple><option value="select">--Select--</option></select>';
